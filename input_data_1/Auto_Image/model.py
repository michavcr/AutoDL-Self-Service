...
class Model(LogicModel):
    ...
    def save(self, output_directory):
        torch.save(self.model, os.path.join(output_directory, "model.pth"))
        torch.save(self.model_9, os.path.join(output_directory, "model_9.pth"))
        with open(os.path.join(output_directory, "info_model.txt"), 'w') as info_file:
            info_file.write("Torch Resnet18 & Resnet9 models\n torch version " + torch.__version__)
