...
class Model():
    ...
    def test(self, dataset, remaining_time_budget=None, unlabelled_data=None):
        """Test method of domain-specific model."""
        # Convert test dataset to necessary format and

        self.tf_dataset_trainsformer.init_test_tfds(dataset, unlabelled_tfds=unlabelled_data)
        
        self.set_domain_dataset(dataset, is_training=False, unlabelled_data=unlabelled_data)
        
        self.real_test_num=self.tf_dataset_trainsformer.real_test_num
        ...
        return Y_pred, self.real_test_num
    ...
    def set_domain_dataset(self, dataset, is_training=True, unlabelled_data=None):
    ...
    def save(self, output_directory):
        print("Model NLP")
        self.domain_model.save(output_directory)
