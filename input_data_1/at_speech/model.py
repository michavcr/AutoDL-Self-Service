...
class Model:
    ...
    def test(self, dataset, remaining_time_budget=None, unlabelled_data=None):
        ...
        cur_y_pred = self.domain_model.test_pipeline(dataset, unlabelled_data=unlabelled_data)
        ...
        print("Predictions shape: ", pred_ensemble.shape)
        return pred_ensemble, self.domain_model.tfds_convertor.true_accm_test_cnt
    
    def save(self, output_directory):
        print("Model At Speech")
